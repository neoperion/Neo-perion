...
const LMSArchitectureDiagram = () => {
  ...
  const nodes = [
    { icon: Users, title: 'Students & Educators', desc: 'Multi-role access with personalized institutional dashboards' },
    { icon: Monitor, title: 'Learning Interface', desc: 'Adaptive content delivery, rubric grading & student pacing' },
    { icon: Bot, title: 'AI Engine', desc: 'Socratic recommendation & zero-hallucination assessment models' },
    { icon: BarChart3, title: 'Analytics Layer', desc: 'Real-time telemetry, retention signals & predictive cohort reports' },
  ];

  useEffect(() => {
    const timer = setInterval(() => setActiveNode(prev => (prev + 1) % nodes.length), 3500);
  ...
  return (
    <div className="relative p-6 sm:p-8 lg:p-10 bg-[#FFFDF9] rounded-2xl border border-manuscript-walnut/25 shadow-sm overflow-hidden">
      ...
      <div className="space-y-3 sm:space-y-4 relative">
        ...
        <div className="absolute left-[27px] sm:left-[31px] top-8 bottom-8 w-[2px] bg-manuscript-walnut/20 z-0" />
        <motion.div
          className="absolute left-[26px] sm:left-[30px] w-[4px] h-14 bg-gradient-to-b from-manuscript-copper to-transparent rounded-full z-10"
          animate={{ top: [24, 72, 120, 168, 24] }}
        ...
        {nodes.map((node, i) => {
          ...
          return (
            <motion.button
              ...
              className={`relative z-20 flex items-center gap-4 sm:gap-5 w-full p-3.5 sm:p-4 rounded-xl border transition-all duration-300 text-left ${
                isActive
                  ? 'bg-manuscript-walnut text-manuscript-parchmentLight shadow-md border-manuscript-walnut scale-[1.01]'
                  : 'bg-manuscript-parchmentLight/80 text-manuscript-ink border-manuscript-walnut/15 hover:bg-manuscript-parchmentWarm'
              }`}
              whileTap={{ scale: 0.99 }}
            ...
            >
              <div className={`w-12 h-12 sm:w-14 sm:h-14 rounded-xl flex items-center justify-center shrink-0 border transition-all duration-300 ${
                isActive
                  ? 'bg-manuscript-parchmentLight text-manuscript-walnut border-manuscript-parchmentWarm'
                  : 'bg-manuscript-parchmentWarm text-manuscript-copper border-manuscript-walnut/20'
              }`}>
                <Icon size={22} />
              </div>
              <div className="flex-1 min-w-0">
                <h4 className={`font-bold font-manuscriptBody text-sm sm:text-[15px] ${isActive ? 'text-manuscript-parchmentLight' : 'text-manuscript-ink'}`}>
                  {node.title}
                </h4>
                <AnimatePresence>
                  {isActive && (
                    <motion.p
                      ...
                      className="text-xs text-manuscript-parchmentWarm mt-1 font-manuscriptBody leading-relaxed"
                    >
                      {node.desc}
                    </motion.p>
                  )}
              ...
              {isActive && (
                <motion.div
                  initial={{ scale: 0 }}
                  animate={{ scale: 1 }}
                  className="w-2.5 h-2.5 rounded-full bg-manuscript-gold shrink-0"
                />
              )}
            </motion.button>
          );
...
export function EducationPage() {
  ...
  return (
    <div className="manuscript-root min-h-screen w-full max-w-full overflow-x-clip box-border parchment-surface text-manuscript-ink selection:bg-manuscript-copper selection:text-white">
      <SEO
      ...
      <main className="w-full max-w-full overflow-x-clip box-border">
        ...
        <section className="pt-36 sm:pt-40 md:pt-48 pb-16 sm:pb-20 md:pb-28 px-4 sm:px-6 lg:px-12 border-b border-manuscript-parchmentDeep relative overflow-hidden w-full max-w-full box-border">
          ...
          <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-10 lg:gap-16 items-center relative z-10 w-full min-w-0">
            <motion.div
            ...
            >
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-lg bg-manuscript-parchmentWarm border border-manuscript-walnut/20 flex items-center justify-center shadow-sm">
                  <GraduationCap className="text-manuscript-walnut" size={20} />
                </div>
              ...
              <p className="font-manuscriptBody text-sm sm:text-base text-manuscript-inkSoft leading-relaxed max-w-xl">
                AINCURU LLP builds AI-powered learning management systems, adaptive assessment engines, and student analytics platforms for universities, K‑12 schools, and EdTech startups. Pilots typically ship in 6–10 weeks; full platforms in 3–6 months.
              </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-6">
              {industry.offerings.map((offering, i) => {
                ...
                return (
                  ...
                  >
                    <div className="w-12 h-12 bg-manuscript-parchmentWarm rounded-xl border border-manuscript-walnut/20 flex items-center justify-center mb-5 text-manuscript-copper">
                      <Icon size={22} />
                    </div>
          ...
          <div className="max-w-6xl mx-auto w-full min-w-0">
            <div className="text-center mb-12 sm:mb-16">
              ...
              <p className="font-manuscriptBody text-base sm:text-lg text-manuscript-inkMuted max-w-2xl mx-auto">
                A battle-tested methodology refined across institutional learning technology projects.
              </p>
            </div>
        ...
        {/* ═══════════════ BENEFITS ═══════════════ */}
        <section id="benefits" className="py-16 sm:py-24 px-4 sm:px-6 lg:px-12 bg-manuscript-parchmentLight border-b border-manuscript-walnut/15 w-full max-w-full overflow-hidden box-border">
          <div className="max-w-6xl mx-auto w-full min-w-0">
            <div className="mb-12 sm:mb-16 text-center sm:text-left">
              <span className="font-mono text-[10px] sm:text-[11px] font-bold tracking-[0.25em] uppercase text-manuscript-copper mb-2 block">
                Why Choose Us
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        ...
                        <ChevronDown
                          className={`shrink-0 text-manuscript-copper transition-transform duration-200 ${isOpen ? 'rotate-180' : ''}`}
                          size={18}
                        />
                      </button>
        ...
        <section className="py-20 sm:py-28 md:py-36 px-4 sm:px-6 lg:px-12 parchment-surface--deep text-center relative overflow-hidden border-t border-manuscript-parchmentDeep w-full max-w-full box-border">
          <div className="container mx-auto max-w-3xl relative z-10 space-y-6 sm:space-y-8 w-full min-w-0 box-border">
            ...
            <p className="font-manuscriptBody text-base sm:text-lg md:text-2xl text-manuscript-inkSoft max-w-xl mx-auto leading-relaxed">
              From dynamic LMS platforms to AI-driven student analytics, let's engineer your learning ecosystem.
            </p>
            ...
            <div className="pt-6 border-t border-manuscript-walnut/15 max-w-xl mx-auto flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-[10px] sm:text-[11px] font-mono uppercase tracking-wider text-manuscript-inkMuted">
              <span>FERPA & LTI-Ready</span>
              <span>·</span>
              <span>Predictable Timelines</span>
              <span>·</span>
