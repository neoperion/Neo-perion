...
const IndustriesHero = () => {
  return (
    <section className="pt-32 pb-20 relative overflow-hidden bg-[#050816] text-center min-h-[60vh] flex items-center">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          Domain <span className="text-transparent bg-clip-text bg-gradient-to-r from-violet-400 to-purple-500">Expertise</span>
        </motion.h1>
        <motion.p
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
              ...
              <section key={industry.id} id={industry.id} className="relative">
                <div className={`flex flex-col ${isEven ? 'lg:flex-row' : 'lg:flex-row-reverse'} gap-12 lg:gap-20 items-center`}>
                  ...
                  <div className="flex-1 space-y-8">
                    <div className="inline-flex items-center justify-center p-4 rounded-2xl bg-white/5 border border-white/10 mb-2">
                      <Icon className="w-8 h-8" style={{ color: industry.color }} />
                    </div>
                    <div>
                      <h2 className="text-4xl md:text-5xl font-display font-bold text-white mb-4 tracking-tight">{industry.title}</h2>
                      <p className="text-lg text-slate-400 leading-relaxed">{industry.description}</p>
                    </div>

                    <div className="space-y-6">
                      <h3 className="text-xl font-bold text-white border-b border-white/10 pb-2">Key Solutions</h3>
                    ...
                    <div className="pt-6">
                      <button className="px-6 py-3 rounded-xl text-white font-medium border border-white/10 hover:bg-white/5 transition-colors flex items-center gap-2 group">
                        Discuss Your Needs
                  ...
                  <div className="flex-1 w-full relative">
                    ...
                    <div className="relative bg-slate-900/60 backdrop-blur-xl border border-white/10 rounded-[2rem] p-8 md:p-12 shadow-2xl">
                      <h3 className="text-2xl font-bold text-white mb-8 tracking-tight">The Neo Perion Advantage</h3>
                      <div className="space-y-6">
