  ...
  return (
    <MobileGate mobileOnly fallback={
      <div className="min-h-screen bg-[#02040A] text-white selection:bg-neo-blue/30">
        <Helmet><title>Careers | Neo Perion</title><meta name="description" content="Join Neo Perion and build the future of intelligent software." /></Helmet>
        <Header /><main><CareersHero /><BenefitsGrid /><JobListings /></main><Footer />
      </div>
    }>
