...
export const BlogSearch: React.FC<Props> = ({ onSearch, theme = 'dark' }) => {
  ...
  return (
    <div className="relative mb-8 w-full max-w-lg">
      ...
      <input
        type="text"
        className="block w-full rounded-xl border border-white/10 parchment-surface--deep/60 py-4 pl-11 pr-10 text-white placeholder-slate-400 transition-all focus:border-transparent focus:outline-none focus:ring-2 focus:ring-orange-500"
