  ...
  },
  {
    ...
    columns: [
      { title: 'ABOUT NEO PERION', items: [
        { label: 'About Us', href: '/about', icon: Building2 }, { label: "Founder's Letter", href: '/company/founder-letter', icon: PenTool },
        { label: 'Vision & Mission', href: '/about#vision', icon: Target }, { label: 'Security', href: '/security', icon: ShieldCheck },
      ]},
      { title: 'SOCIAL PROOF', items: [
        { label: 'Case Studies', href: '/case-studies', icon: FileText }, { label: 'Success Stories', href: '/success-stories', icon: TrendingUp }, { label: 'Testimonials', href: '/testimonials', icon: MessageSquare },
      ]},
      { title: 'CAREERS', items: [
        { label: 'Join Our Team', href: '/careers', icon: Briefcase }, { label: 'Internship Program', href: '/careers/internships', icon: GraduationCap }, { label: 'Open Positions', href: '/careers#open-roles', icon: Briefcase },
      ]},
      { title: 'RESOURCES', items: [
        { label: 'Blog', href: '/blog', icon: BookOpen }, { label: 'AI Newsletter', href: '/newsletter', icon: Newspaper }, { label: 'Technology Insights', href: '/insights', icon: Cpu },
      ]},
    ],
