        ...
        <div className="relative rounded-[2.5rem] p-8 md:p-16 overflow-hidden bg-slate-900 border border-slate-800 shadow-2xl">
          ...
          <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-12">
            <div className="lg:max-w-2xl text-center lg:text-left">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4 justify-center lg:justify-start">
                ...
                <button 
                  ...
                  className="w-full sm:w-auto px-8 py-4 rounded-xl bg-white/10 text-white font-bold flex items-center justify-center hover:bg-white/20 transition-colors backdrop-blur-sm border border-white/10"
                >
                  View Case Studies
                </button>
              </div>
            ...
            <div className="w-full lg:w-auto">
              <div className="bg-white/5 backdrop-blur-md rounded-2xl p-6 md:p-8 border border-white/10 flex flex-col gap-4">
                {[
                  'Enterprise Ready',
