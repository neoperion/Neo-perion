...
export const WhyNeoPerion = () => {
  ...
  return (
    <section id="why-neo-perion" className="py-20 md:py-32 bg-[#050816] relative overflow-hidden">
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[1000px] h-[800px] bg-blue-900/10 rounded-full blur-[120px] pointer-events-none"></div>
