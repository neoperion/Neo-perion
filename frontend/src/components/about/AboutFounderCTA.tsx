      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-12 max-w-6xl relative z-10 w-full box-border">
        <div className="grid md:grid-cols-12 gap-12 lg:gap-20 items-center">
          ...
          <motion.div
            ...
            className="md:col-span-6 lg:col-span-5 w-full box-border font-sans"
          >
            <p className="font-sans text-[11px] font-bold uppercase tracking-[0.25em] !text-manuscript-gold mb-4">
              08 · FOUNDER LETTER
            </p>
            <h2 className="font-sans font-bold text-3xl md:text-5xl lg:text-6xl leading-tight tracking-tight mb-8 !text-manuscript-parchmentLight break-words">
              There is more<br />to the story.
            </h2>
            
            <div className="font-sans text-[16px] md:text-[18px] leading-[1.8] !text-manuscript-parchment/90 space-y-6 mb-12">
              <p>
          ...
          <motion.div
            ...
            className="md:col-span-6 lg:col-span-7 relative font-sans"
          >
            ...
            <div className="relative aspect-[4/5] md:aspect-square lg:aspect-[4/3] overflow-hidden rounded-sm bg-manuscript-ink/50 shadow-2xl">
              ...
              <div className="absolute bottom-6 left-6 z-20">
                <p className="font-sans font-bold text-2xl md:text-3xl !text-manuscript-parchmentLight leading-none mb-1 tracking-tight">Vasantharaj S</p>
                <p className="font-sans text-[11px] tracking-[0.2em] uppercase !text-manuscript-gold font-bold">Founder & CEO</p>
              </div>
            </div>
          </motion.div>
