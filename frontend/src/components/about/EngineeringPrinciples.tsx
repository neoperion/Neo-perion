      ...
      <div className="container mx-auto px-6 lg:px-12 max-w-6xl">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {principles.map((principle, index) => (
            <div key={index} className="bg-neutral-900 border-[0.5px] border-[#27272A] rounded-xl p-10 flex flex-col items-start group hover:border-[#A1A1AA] hover:-translate-y-0.5 transition-all duration-150 ease-out shadow-sm">
