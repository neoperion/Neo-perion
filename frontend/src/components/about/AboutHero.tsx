...
export function AboutHero() {
  return (
    <div className="relative overflow-hidden parchment-surface border-b border-manuscript-parchmentDeep pt-28 md:pt-36 pb-16 md:pb-20">
      ...
      {/* ── Content ───────────────────────────────────────────── */}
      <div className="relative z-10 px-4 sm:px-6 md:px-16 lg:px-24 container mx-auto max-w-7xl font-sans">
        ...
        <div className="grid lg:grid-cols-12 gap-8 sm:gap-12 lg:gap-20 items-end">
          <div className="lg:col-span-7">
            ...
            >
              ...
              <span className="font-sans text-[11px] font-semibold uppercase tracking-[0.2em] text-manuscript-copperMuted">
                COMPANY RECORD · 001
              </span>
            </motion.div>
            ...
            <div className="overflow-hidden mb-1">
              <motion.h1
                ...
                className="font-sans font-bold leading-[1.05] tracking-tight text-manuscript-ink"
            ...
            <div className="overflow-hidden mb-8 sm:mb-10">
              <motion.h1
                ...
                className="font-sans font-bold leading-[1.05] tracking-tight text-manuscript-copper"
                style={{ fontSize: 'clamp(2.25rem, 6vw, 5.5rem)' }}
              >
          ...
          >
            <p className="font-sans text-[16px] sm:text-[17px] leading-[1.75] text-manuscript-inkMuted mb-6">
            ...
            <div className="font-sans text-[11px] font-semibold uppercase tracking-[0.2em] text-manuscript-copperMuted mb-8 sm:mb-10">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4 w-full">
              ...
              <a
                href="#origin"
                className="font-sans font-semibold text-[14px] text-manuscript-copper transition-colors duration-200 hover:text-manuscript-rust flex items-center gap-1.5"
              >
                Read our story
                <ArrowDown size={14} />
              </a>
