...
export function AboutMethod() {
  return (
    <section className="py-16 md:py-24 parchment-surface--light border-b border-manuscript-parchmentDeep overflow-hidden relative">
      ...
      <div className="container mx-auto px-6 lg:px-12 max-w-6xl relative z-10 font-sans">
        <div className="text-center mb-16 md:mb-24 max-w-3xl mx-auto">
          ...
          <h2 className="font-sans font-bold text-3xl sm:text-4xl md:text-5xl leading-tight text-manuscript-ink tracking-tight mb-4">
            Context before intelligence.
          </h2>
          <p className="font-sans text-[16px] md:text-[18px] text-manuscript-inkSoft">
        ...
        <div className="hidden lg:block relative h-[500px] w-full max-w-4xl mx-auto">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-48 h-48 rounded-full border border-manuscript-copper flex items-center justify-center bg-manuscript-parchment z-20">
            <div className="text-center">
              <span className="block font-sans text-[11px] font-bold tracking-[0.25em] text-manuscript-copper">AINCURU</span>
              <span className="block font-sans font-extrabold text-base tracking-widest text-manuscript-ink mt-1">METHOD</span>
            </div>
          </div>
          ...
          <motion.div initial={{ opacity: 0, y: 10 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.1 }} className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-6 text-center w-48 z-10">
            <span className="font-sans text-[11px] font-bold text-manuscript-copper block mb-1">01</span>
            <h4 className="font-sans font-bold text-lg text-manuscript-ink mb-1 tracking-tight">Understand</h4>
          ...
          <motion.div initial={{ opacity: 0, x: -10 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ delay: 0.2 }} className="absolute top-[20%] right-[5%] translate-x-4 text-center w-48 z-10">
            <span className="font-sans text-[11px] font-bold text-manuscript-copper block mb-1">02</span>
            <h4 className="font-sans font-bold text-lg text-manuscript-ink mb-1 tracking-tight">Frame</h4>
          ...
          <motion.div initial={{ opacity: 0, x: -10 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ delay: 0.3 }} className="absolute bottom-[20%] right-[5%] translate-x-4 text-center w-48 z-10">
            <span className="font-sans text-[11px] font-bold text-manuscript-copper block mb-1">03</span>
            <h4 className="font-sans font-bold text-lg text-manuscript-ink mb-1 tracking-tight">Build</h4>
          ...
          <motion.div initial={{ opacity: 0, x: 10 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ delay: 0.4 }} className="absolute bottom-[20%] left-[5%] -translate-x-4 text-center w-48 z-10">
            <span className="font-sans text-[11px] font-bold text-manuscript-copper block mb-1">04</span>
            <h4 className="font-sans font-bold text-lg text-manuscript-ink mb-1 tracking-tight">Ship</h4>
          ...
          <motion.div initial={{ opacity: 0, x: 10 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ delay: 0.5 }} className="absolute top-[20%] left-[5%] -translate-x-4 text-center w-48 z-10">
            <span className="font-sans text-[11px] font-bold text-manuscript-copper block mb-1">05</span>
            <h4 className="font-sans font-bold text-lg text-manuscript-ink mb-1 tracking-tight">Learn</h4>
        ...
        <div className="lg:hidden space-y-8 relative">
          ...
          {methods.map((method, idx) => (
            <div key={method.number} className="relative pl-10">
              ...
              <span className="font-sans text-[11px] font-bold text-manuscript-copper block mb-1">{method.number}</span>
              <h4 className="font-sans font-bold text-lg text-manuscript-ink mb-2 tracking-tight">{method.title}</h4>
        ...
        <div className="mt-20 text-center border-t border-manuscript-parchmentDeep pt-12">
          <p className="font-sans font-medium text-lg md:text-xl text-manuscript-ink">
