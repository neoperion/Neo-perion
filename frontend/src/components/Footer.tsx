        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12 lg:gap-8 mb-16">
          ...
          <div className="lg:col-span-1">
            ...
            <ul className="space-y-4 text-sm">
              ...
              <li><a href="/case-studies" className="hover:text-[#00d4ff] transition-colors">Case Studies</a></li>
              <li><a href="/technologies" className="hover:text-[#00d4ff] transition-colors">Documentation</a></li>
              <li><a href="/contact" className="hover:text-[#00d4ff] transition-colors">Help Center</a></li>
            </ul>
          </div>
          ...
          <div className="lg:col-span-1">
            ...
            <ul className="space-y-4 text-sm">
              <li><a href="/security" className="hover:text-[#00d4ff] transition-colors">Privacy Policy</a></li>
              <li><a href="/security" className="hover:text-[#00d4ff] transition-colors">Terms of Service</a></li>
              <li><a href="/security" className="hover:text-[#00d4ff] transition-colors">Cookie Policy</a></li>
            </ul>
          </div>
          ...
          <div className="lg:col-span-1">
            ...
            <ul className="space-y-4 text-sm">
              <li><a href="/contact" className="hover:text-[#00d4ff] transition-colors">Pricing</a></li>
              <li><a href="/services/business-automation" className="hover:text-[#00d4ff] transition-colors">Enterprise</a></li>
              <li><a href="/technologies" className="hover:text-[#00d4ff] transition-colors">Integrations</a></li>
              <li><a href="/success-stories" className="hover:text-[#00d4ff] transition-colors">Changelog</a></li>
            </ul>
          </div>
        </div>
