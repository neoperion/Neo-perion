  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      <video
        ...
        src="/images/19827952-hd_1920_1080_24fps.mp4"
      />

      {/* Gradient: transparent at top, dark from midpoint down for text legibility */}
      <div className="absolute inset-0 bg-gradient-to-t from-[#0A0A0B] via-[#0A0A0B]/75 to-transparent" style={{ background: 'linear-gradient(to top, #0A0A0B 0%, rgba(10,10,11,0.80) 38%, rgba(10,10,11,0.25) 65%, transparent 100%)' }} />
      {/* Left vignette */}
      <div className="absolute inset-0" style={{ background: 'linear-gradient(to right, rgba(10,10,11,0.65) 0%, rgba(10,10,11,0.20) 50%, transparent 100%)' }} />

      {/* Orange top frame line — sweeps in on load */}
      <motion.div
        initial={{ scaleX: 0 }}
        animate={{ scaleX: 1 }}
      ...
      {/* Content — ABSOLUTELY at bottom-left, always anchored regardless of height */}
      <div className="absolute bottom-0 left-0 right-0 z-10 px-8 pb-16 md:px-16 md:pb-16 lg:px-24 lg:pb-20">
        ...
        {/* Headline — two lines, clip-reveal from bottom */}
